...
const AddRecipeForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const addRecipe = await createRecipe(newFormData);
            ...
            <div className="card shadow p-4 rounded">
              ...
              <form autoComplete="off" onSubmit={handleSubmit}>
                <div className="col-lg-10">
                  <label htmlFor="owner" className="form-control form-label">
                    Owner
                    <input
                      type="text"
                ...
                <div className="col-lg-10">
                  <label htmlFor="level" className="form-control form-label">
                    Level
                    <select
                      className="form-control"
                      name="level"
                ...
                <div className="col-lg-10">
                  <label htmlFor="cuisine" className="form-control form-label">
                    Cuisine
                    <select
                      className="form-control"
                      name="cuisine"
                ...
                <div className="col-lg-10">
                  <label htmlFor="tools" className="form-control form-label">
                    Tools
                    <DropDownList
                      selectedOptions={selectedOptions}
                      setSelectedOptions={setSelectedOptions}
                      onChange={(e) => handleToolsChange(selectedOptions)}
                    />
                  </label>
                </div>
                <div className="col-lg-10">
                  <label htmlFor="image" className="form-control form-label">
                    Image
                    <input
                      type="text"
                      className="form-control"
                ...
                <div className="col-lg-10">
                  <label htmlFor="serves" className="form form-label">
                    Serves
                    <input
                      type="number"
                      min="1"
